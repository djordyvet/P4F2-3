...
class HMIApp:
    def __init__(self, root):
        ...
        self.light1 = tk.Label(self.light_frame, text="Light 1", font=("Helvetica", 16), fg="Gray")
        self.light1.grid(row=0, column=0, padx=5)
        self.light2 = tk.Label(self.light_frame, text="Light 2", font=("Helvetica", 16), fg="Gray")
